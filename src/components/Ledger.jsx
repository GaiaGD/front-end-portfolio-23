    ...
    <div className='project-title md:mt-32 mt-16'>
      ...
      <div className='md:flex my-16'>
        <div className='md:w-3/6'>
          <img className="md:my-16 mx-auto w-full md:w-auto max-h-[40rem]" src='./projects/ledger-hp-preview-1.png' />
          <img className="md:my-16 mx-auto w-full md:w-auto max-h-[40rem]" src='./projects/ledger-hp-preview-2.png' />
        </div>
        <div className='md:w-3/6'>
